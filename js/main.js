...
var registrationForm = {
	init : function(){
		...
		jQuery.validator.addMethod("domain", function(value, element) {
  			return this.optional(element) || /^([a-zA-Z0-9][-a-zA-Z0-9]*[a-zA-Z0-9]\.)+([a-zA-Z0-9]{2,5})$/.test(value);
		...
		$('#domain-form').validate({
			...
			submitHandler : registrationForm.submit
		});
	},
	submit : function(){
...
$('section#signup').css('display','block');

var $panels = $('#slider .scroll-container > section');
